...
public class ItineraryDetails extends Fragment {
    private FragmentItineraryDetailsBinding binding;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        binding = FragmentItineraryDetailsBinding.inflate(inflater, container, false);
        ...
        itineraryQuery.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                ...
                ItineraryPagerAdapter vpAdapter = new ItineraryDetails.ItineraryPagerAdapter(getContext(), getActivity().getSupportFragmentManager(), fragments, dates);
