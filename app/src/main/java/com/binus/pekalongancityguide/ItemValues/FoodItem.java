...
public class FoodItem {
    ...
    public static String[] fooddesc = {
            ...
            "\t\tTauto Pekalongan is a specialty of Pekalongan Regency that comes from a fusion of Chinese and Indian cuisine. Tauto is derived from Caudo (Chinese soup) and the Indian spice Tauco. People outside Pekalongan often call it Soto Pekalongan. This soup is usually made from beef or chicken and flavored with tauco.\n\t\t\tLike other soto, the deliciousness of Pekalongan soto lies in its tender meat and clear, savory broth.",
